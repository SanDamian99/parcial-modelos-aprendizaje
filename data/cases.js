...
const GAME_CASES = [
    {
        ...
        type: "clasico_basico",
        elements: {
            "EN": "Sonido de ambulancia (antes)",
            "EI": "Infarto",
            "RI": "Miedo intenso / Dolor",
            "EC": "Sonido de ambulancia (ahora)",
            "RC": "Temblor / Ansiedad"
        },
    ...
    },
    {
        ...
        id: "medio",
        title: "NIVEL 2: Medio",
        description: "Julián llegaba tarde todos los días. Su jefe primero lo ignoró completamente. Con el tiempo Julián llegó aún más tarde. Luego el jefe cambió de estrategia: cada vez que Julián llegaba a tiempo, le daba reconocimiento público en la reunión. En dos semanas, Julián llegaba 10 minutos antes.",
        type: "timeline_operante",
        phases: [
            { id: "fase1", text: "Fase 1: El jefe lo ignora y él llega más tarde.", options: ["Castigo Positivo", "Castigo Negativo", "Reforzamiento Positivo", "Reforzamiento Negativo", "Ninguno de los anteriores / Ignorar no redujo la conducta"], correct: "Ninguno de los anteriores / Ignorar no redujo la conducta" },
            { id: "fase2", text: "Fase 2: Llega a tiempo y recibe reconocimiento.", options: ["Castigo Positivo", "Castigo Negativo", "Reforzamiento Positivo", "Reforzamiento Negativo", "Extinción"], correct: "Reforzamiento Positivo" }
        ],
        question: "¿Qué habría pasado si el jefe hubiera aplicado castigo positivo en lugar de reforzamiento positivo?",
        question_options: [
            "Habría generado evitación o resentimiento en Julián, posiblemente ocultando la conducta.",
        ...
        maintenance_options: [
            ...
            "Programa de Intervalo Fijo (Reconocimiento el viernes)",
    ...
    },
    {
        ...
        terms: ["Modelo", "Observador", "Atención", "Retención", "Reproducción", "Refuerzo Vicario"],
        correct_sequence: ["Modelo", "Observador", "Atención", "Retención", "Reproducción", "Refuerzo Vicario"], // Validaremos solo que pertenezcan y estén en orden lógico en el drag
    ...
    },
    {
        ...
        description: "El colegio Simón Bolívar tiene un problema: los estudiantes no estudian. El rector implementó simultáneamente: (1) exámenes sorpresa aleatorios, (2) ranking de mejores notas en cartelera, (3) retiró los recreos a quienes reprobaran, y (4) contrató a un ex-estudiante exitoso para charlas.",
        type: "integrador",
        interventions: [
            { id: "i1", text: "1. Exámenes sorpresa aleatorios", theory_options: ["Clásico", "Operante", "Social"], theory_correct: "Operante", mech_options: ["Castigo Positivo", "Castigo Negativo", "Programa de Intervalo Variable"], mech_correct: "Programa de Intervalo Variable" },
            { id: "i2", text: "2. Ranking de mejores notas", theory_options: ["Clásico", "Operante", "Social"], theory_correct: "Social", mech_options: ["Incentivo Vicario / Modelo", "Castigo Positivo", "Extinción"], mech_correct: "Incentivo Vicario / Modelo" },
            { id: "i3", text: "3. Retira recreos a reprobados", theory_options: ["Clásico", "Operante", "Social"], theory_correct: "Operante", mech_options: ["Castigo Positivo", "Castigo Negativo", "Refuerzo Negativo"], mech_correct: "Castigo Negativo" },
            { id: "i4", text: "4. Charlas de ex-estudiante", theory_options: ["Clásico", "Operante", "Social"], theory_correct: "Social", mech_options: ["Modelamiento", "Autoeficacia", "Desensibilización"], mech_correct: "Modelamiento" }
        ],
